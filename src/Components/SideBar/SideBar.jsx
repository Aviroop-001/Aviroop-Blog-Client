...
const SideBar = () => {
  ...
  return (
    <div className='SideBar'>
        ...
        <p className="sidebarContent">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam nihil aperiam beatae dignissimos quod impedit sunt ipsa? Modi, repudiandae. Accusamus.</p>
